...
//			getJTabbedPanelConfig().getComponentAt(0).setEnabled(true); // show the net tab while we disconnect from the serial
		...
		if ("stop".equals(action)) {
			...
			// playSong(com.hackingroomba.roombacomm,"Baa Baa Black Sheep:d=4,o=5,b=125:c,c,g,g,8a,8b,8c6,8a,g,p,f,f,e,e,d,d,c");
			roombaComm.stop();
	 ...
	 * Update display.
	 * 
	 * @param roombacomm the com.hackingroomba.roombacomm
