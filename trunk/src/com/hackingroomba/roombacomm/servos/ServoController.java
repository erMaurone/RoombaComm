package com.hackingroomba.roombacomm.servos;
        ...
        try {
            ...
            while (true) {
                ...
                for (counter=0; counter<repeatLoop; counter++) {
                    ...
                    // Pulse Width determined by amount of sleep time while HIGH
                ...
                /*--- Move servo counterclockwise to 0degree position ---*/
                // Create a pulse for repeatLoop number of cycles
                for (counter=0; counter<repeatLoop; counter++) {
                    ...
                    // Pulse Width determined by amount of time while HIGH
                    ...
                    // Frequency determined by amount of time while LOW
                    java.lang.Thread.sleep(period);
                }
            }
