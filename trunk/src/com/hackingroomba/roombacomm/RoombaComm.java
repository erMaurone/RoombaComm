...
public abstract class RoombaComm
{
    ...
    private final Logger logger = Logger.getLogger(RoombaComm.class);
	...
	/** set of flags for the current state of the LEDs */
	 ...
	 *  com.hackingroomba.roombacomm.waitForDSR = true;
...
spinright = -127 83
    ...
    public void logmsg(String msg) {
        if(debug)
        {
            logger.info("RoombaComm ("+System.currentTimeMillis()+"):"+msg);
        }
    }
