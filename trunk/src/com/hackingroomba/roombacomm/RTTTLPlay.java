...
/*
 ...
 Run it with something like: <pre>
  java com.hackingroomba.roombacomm.RTTTLPlay /dev/cu.KeySerial1 'tron:d=4,o=5,b=200:8f6,8c6,8g,e,8p,8f6,8c6,8g,8f6,8c6,8g,e,8p,8f6,8c6,8g,e.,2d'<br>
 Usage:
 com.hackingroomba.roombacomm.RTTTLPlay serialportname [protocol] rttl_string [options]<br>
 where:
...
public class RTTTLPlay {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.RTTTLPlay <serialportname> [protocol] <rttl string> [options]\n" +
        "where:\n"+
        "protocol (optional) is SCI or OI\n"+
