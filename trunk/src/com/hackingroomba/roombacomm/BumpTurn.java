/*
 * com.hackingroomba.roombacomm.BumpTurn -- turn away from bumps
 *
...
/**
   ...
   Run it with something like: <pre>
    java com.hackingroomba.roombacomm.BumpTurn /dev/cu.KeySerial1<br>
   Usage: 
   com.hackingroomba.roombacomm.Drive serialportname [protocol] [options]
   where:
...
public class BumpTurn {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Drive <serialportname> [protocol]" +
        "" +
        " [options]\n" +
