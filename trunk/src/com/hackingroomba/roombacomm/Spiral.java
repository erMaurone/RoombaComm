/*
 * com.hackingroomba.roombacomm.Spiral -- test out the DRIVE command, showing a spiral
 *
...
/**
  ...
  <p>
   Run it with something like: <pre>
    java com.hackingroomba.roombacomm.Spiral /dev/cu.KeySerial1<br>
    Usage: 
      com.hackingroomba.roombacomm.Spiral <serialportname> [protocol] [options]<br>
...
public class Spiral {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Spiral <serialportname> [protocol] [options]\n" +
        "where: protocol (optional) is SCI or OI\n" +
        "[options] can be one or more of:\n"+
        " -debug       -- turn on debug output\n"+
        " -hwhandshake -- use hardware-handshaking, for Windows Bluetooth\n"+
