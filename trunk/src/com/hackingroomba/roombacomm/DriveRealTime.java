...
/**
  ...
  <p>
   Run it with something like: <pre>
    java com.hackingroomba.roombacomm.DriveRealTime /dev/cu.KeySerial1<br>
   Usage: 
   com.hackingroomba.roombacomm.DriveRealTime serialportname [protocol] [options]<br>
   where: 
...
public class DriveRealTime extends JFrame implements KeyListener {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.DriveRealTime <serialportname> [protocol] [options] \n" +
