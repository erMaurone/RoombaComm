/*
 * com.hackingroomba.roombacomm.Drive -- test out the DRIVE command
 *
 ...
 *   java com.hackingroomba.roombacomm.Drive /dev/cu.KeySerial1 byte1 byte2 byte3 byte4<br>
 *  Usage:
 *  com.hackingroomba.roombacomm.Drive serialportname [protocol] velocity radius waittime [options]<br>
...
public class Drive {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Drive <serialportname> [protocol] <velocity> <radius> <waittime> [options]\n" +
        "where protocol (optional) is SCI or OI\n" +
        "[options] can be one or more of:\n"+
        " -debug       -- turn on debug output\n"+
        " -hwhandshake -- use hardware-handshaking, for Windows Bluetooth\n"+
