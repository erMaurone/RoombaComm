...
/**
  ...
  Run it with something like: <pre>
    java com.hackingroomba.roombacomm.Test /dev/cu.KeySerial1
  Usage: 
  com.hackingroomba.roombacomm.Test serialportname [protocol] [options]<br>
...
public class Test {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Test <serialportname> [protocol] [options]\n" +
        "where: protocol (optional) is SCI or OI\n" +
        "[options] can be one or more of:\n"+
        " -debug       -- turn on debug output\n"+
        " -hwhandshake -- use hardware-handshaking, for Windows Bluetooth\n"+
    ...
    public static void main(String[] args) {
        ...
        //com.hackingroomba.roombacomm.turn();
        
        /*
        //    com.hackingroomba.roombacomm.goStraight( 100, 100 );
        com.hackingroomba.roombacomm.spinLeft(  100, 360 );
        com.hackingroomba.roombacomm.spinRight( 200, 360 );
        com.hackingroomba.roombacomm.spinLeft(  300, 360 );
        com.hackingroomba.roombacomm.spinRight( 400, 360 );
        com.hackingroomba.roombacomm.spinLeft(  500, 360 );
        com.hackingroomba.roombacomm.spinRight( 600, 360 );
        */
