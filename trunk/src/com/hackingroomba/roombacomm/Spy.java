/*
 * com.hackingroomba.roombacomm.Spy
 *
...
/**
  ...
  <p>
   Run it with something like: <pre>
    java com.hackingroomba.roombacomm.Spy /dev/cu.KeySerial1<br>
   Usage:
     com.hackingroomba.roombacomm.Spy <serialportname> [protocol] [options]<br>
...
public class Spy {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Spy <serialportname> [protocol] [options]\n" +
        "where: protocol (optional) is SCI or OI\n" +
        " [options] can be one or more of:\n"+
        " -pause <n>   -- pause n millseconds between sensor read\n"+
        " -debug       -- turn on debug output\n"+
