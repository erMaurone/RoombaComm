/*
 * com.hackingroomba.roombacomm.SpySimple
 *
...
/**
  ...
  Run it with something like: <pre>
    java com.hackingroomba.roombacomm.SpySimple /dev/cu.KeySerial1
  Usage: 
  com.hackingroomba.roombacomm.SpySimple serialportname [protocol] [options]<br>
...
public class SpySimple {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.SpySimple <serialportname> [protocol] [options]\n" +
        "where: protocol (optional) is SCI or OI\n" +
        "[options] can be one or more of:\n"+
        " -pause <n>   -- pause n millseconds between sensor read\n"+
        " -debug       -- turn on debug output\n"+
