/*
 * com.hackingroomba.roombacomm.Waggle -- test out the DRIVE command, showing a waggle
 *
...
/**
  ...
  Run it with something like: <pre>
   java com.hackingroomba.roombacomm.Waggle /dev/cu.KeySerial1 [protocol] velocity radius waittime [options]
  where: 
...
public class Waggle {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Waggle <serialportname> [protocol] <velocity> <radius> <waittime> [options]\n" +
