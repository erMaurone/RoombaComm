/*
 * com.hackingroomba.roombacomm.RoombaCommCLI -- test out RoombaComm library by issuing commands to it from the command line
 *
 ...
 */
	...
	public boolean connect(String portName)
	{
		...
		// init robot, which is used for the standard com.hackingroomba.roombacomm commands
		if ((protocol.equalsIgnoreCase("AR")) || (protocol.equalsIgnoreCase("MO"))) {
			robot = new ArduinoBot(robotConnection);	// superclass of com.hackingroomba.roombacomm
		} else {
			robot = new RoombaCommTCPClient(robotConnection);	// superclass of com.hackingroomba.roombacomm
		}
		...
		if (protocol.equalsIgnoreCase("FR")) {
			...
			arduino = new ArduinoBot(arduinoConnection);	// it's actually a superclass of com.hackingroomba.roombacomm
