/*
 * com.hackingroomba.roombacomm.Spiro1 -- a Spirograph-like example
 *
...
/**
 ...
 <p>
  Run it with something like: <pre>
   java com.hackingroomba.roombacomm.Spiro1 /dev/cu.KeySerial1 velocity radius waittime<br>
  Usage: \n"+
    com.hackingroomba.roombacomm.Spiro1 <serialportname> [protocol] <velocity> <radius> <waittime> [options]<br>
  where: 
...
public class Spiro1 {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.Spiro1 <serialportname> [protocol] <velocity> <radius> <waittime> [options]\n" +
