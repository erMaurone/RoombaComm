...
/**
  ...
  Run it with something like: <pre>
   java com.hackingroomba.roombacomm.SpyAuto /dev/cu.KeySerial1
  Usage: 
  com.hackingroomba.roombacomm.SpyAuto serialportname [protocol] [options]<br>
...
public class SpyAuto {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.SpyAuto <serialportname> [protocol] [options]\n" +
        "where: protocol (optional) is SCI or OI\n" +
        "[options] can be one or more of:\n"+
        " -pause <n>   -- pause n millseconds between sensor read\n"+
        " -debug       -- turn on debug output\n"+
    ...
    public static void purr() {
        ...
        com.hackingroomba.roombacomm.playSong( 2 );
        for( int i=72; i>60; i-- ) {
            com.hackingroomba.roombacomm.spinLeftAt( 1000 );
            com.hackingroomba.roombacomm.pause( s64ths/2 );
            com.hackingroomba.roombacomm.spinRightAt( 1000 );
            com.hackingroomba.roombacomm.pause( s64ths/2 );
    ...
    public static void createTribblePurrSong() {
        byte cmd[] = {
            ...
            68, 4,  67, 4,  66, 4,  65, 4,
            64, 4,  63, 4,  62, 4  };
        com.hackingroomba.roombacomm.send( cmd );
    }
    
   
    public static void bark() {
        System.out.println("bark");
        com.hackingroomba.roombacomm.vacuum(true);
        com.hackingroomba.roombacomm.playNote( 50, 5 );
        com.hackingroomba.roombacomm.pause(150);
        com.hackingroomba.roombacomm.vacuum(false);
    }
    */    
