/*
 * com.hackingroomba.roombacomm.Bsquare -- test out the Bsquare command
 *
...
/**	
	  ...
	  <p>
	   Run it with something like: <pre>
	    java com.hackingroomba.roombacomm.Bsquare /dev/cu.KeySerial1 [protocol] command velocity distance<br>
     Usage:
       com.hackingroomba.roombacomm.Bsquare <serialportname> [protocol] <command> <velocity> <distance> [options]<br>
     where 
...
*/	 
	public class Roborama {
		...
		String usage = 
	        "Usage: \n"+
	        "  com.hackingroomba.roombacomm.Roborama <serialportname> [protocol] <command> <velocity> <distance> [options]\n" +
		...
		byte [] sensorBytes;	// The last bytes read by com.hackingroomba.roombacomm library
		byte bumpSensor;
	    short odoDistance;
		...
		public void f()
		{
        	...
        	com.hackingroomba.roombacomm.queryList(sensorList, 6);
        	boolean sensorStatus = com.hackingroomba.roombacomm.wait4Sensors();
        	if (sensorStatus == false) {
        		System.out.println("Failed to read sensors");		// wait until sensorsValid true, when 6 bytes ready
        		System.exit(-1);
        	}
        	sensorBytes = com.hackingroomba.roombacomm.getSensor_bytes();
        	odoDistance = com.hackingroomba.roombacomm.toShort(sensorBytes[0], sensorBytes[1]);
        	leftEncoder = com.hackingroomba.roombacomm.toShort(sensorBytes[2], sensorBytes[3]);
        	rightEncoder = com.hackingroomba.roombacomm.toShort(sensorBytes[4], sensorBytes[5]);
...
/*	            
        	...
        	com.hackingroomba.roombacomm.queryList(sensorList, 6);
        	sensorStatus = com.hackingroomba.roombacomm.wait4Sensors();
        	if (sensorStatus == false) {
        		System.out.println("Failed to read sensors");		// wait until sensorsValid true, when 6 bytes ready
        		System.exit(-1);
        	}
...
*/	            
		...
		public void onb()
		{
            ...
            roombacomm.stop();
            roombacomm.pause(1000);
            //com.hackingroomba.roombacomm.spin(360);
		}
...
//	        	roombacommTCPClient.setProtocol(args[1]);
	        ...
	        roombacomm.control();
//over ride 
	        // com.hackingroomba.roombacomm.full();
