...
//        }
	...
	public boolean connect() {
		...
		// com.hackingroomba.roombacomm.debug=true;
		...
		if (portname != null){
			...
			// 	com.hackingroomba.roombacomm.debug=false;
	...
	public boolean connectNet(String portname) {
		...
		// com.hackingroomba.roombacomm.setSensorsAutoUpdate(true);
	...
	public void actionPerformed(ActionEvent event) {
		...
		updateDisplay(formatter.format(new Date()) + ": action (" + action
				+ ") happened\n", this.debug);
		// com.hackingroomba.roombacomm.setLEDs(false, false, false, false, false, false, 0, 0);
...
//			getJTabbedPanelConfig().getComponentAt(0).setEnabled(true); // show the net tab while we disconnect from the serial
		...
		if ("stop".equals(action)) {
			...
			/*
			 * updateDisplay("Playing some notes\n"); com.hackingroomba.roombacomm.playNote( 72,
			 * 10 ); // C com.hackingroomba.roombacomm.pause( 200 ); com.hackingroomba.roombacomm.playNote( 79, 10
			 * ); // G com.hackingroomba.roombacomm.pause( 200 ); com.hackingroomba.roombacomm.playNote( 76, 10 );
			 * // E com.hackingroomba.roombacomm.pause( 200 );
			 * 
			 * updateDisplay("Spinning left, then right\n");
			 * com.hackingroomba.roombacomm.spinLeft(); com.hackingroomba.roombacomm.pause(1000);
			 * com.hackingroomba.roombacomm.spinRight(); com.hackingroomba.roombacomm.pause(1000);
			 * com.hackingroomba.roombacomm.stop();
			 * 
			 * updateDisplay("Going forward, then backward\n");
			 * com.hackingroomba.roombacomm.goForward(); com.hackingroomba.roombacomm.pause(1000);
			 * com.hackingroomba.roombacomm.goBackward(); com.hackingroomba.roombacomm.pause(1000);
			 * com.hackingroomba.roombacomm.stop();
			 */
			...
			// String[]
			// osuSong={com.hackingroomba.roombacomm.getPortname(),"OSU:d=4,o=5,b=125:a,g,a#,a,8g#,a,8g#,2a,8p,8f,8g,8g#,a,8g#,a,8g#,a,g,f,a,g,8a,g,d,8f,8p,8f,8p,8f,8p,8f,8p,c6,a,g,f,8a#,a,8g,f,p,c6,a,g,a,8a#,a,8a#,c6,p,2d6,d,8c6,a#,g,f,8f,8f,8g,a#,8g,a#,a,2a#"};
			playSong(
					roombaComm,
			...
			// playSong(com.hackingroomba.roombacomm,
...
//		// displayText.getParent().validate();
	...
	protected void setChgMaxLED(RoombaComm roombacomm, boolean max) {
		...
		// this.toggleMax=max;
		// this.setLEDs(com.hackingroomba.roombacomm);
