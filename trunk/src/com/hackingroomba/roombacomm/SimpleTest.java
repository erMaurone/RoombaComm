/*
 * com.hackingroomba.roombacomm.SimpleTest
 *
...
/**
  ...
  <p>
   Run it with something like: <pre>
    java com.hackingroomba.roombacomm.SimpleTest /dev/cu.KeySerial1<br>
    Usage:
      com.hackingroomba.roombacomm.SimpleTest serialportname [protocol] [options]<br>
    where:
...
public class SimpleTest {
    ...
    static String usage = 
        "Usage: \n"+
        "  com.hackingroomba.roombacomm.SimpleTest <serialportname> [protocol] [options]\n" +
        "where:\n"+
        "protocol (optional) is SCI or OI\n"+
        "[options] can be one or more of:\n"+
        " -debug       -- turn on debug output\n"+
