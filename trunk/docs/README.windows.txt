...
-----------------------
- unzip com.hackingroomba.roombacomm somewhere
...
- Copy rxtxSerial.dll from com.hackingroomba.roombacomm\rxtxlib folder to the folder with java.exe. For
...
- Open a command prompt window and cd to the directory where you unzipped com.hackingroomba.roombacomm
...
the command line. e.g. 
  > runit com.hackingroomba.roombacomm.DriveRealTime COM4 -hwhandshake
...
Processing
----------
- If you change any RoombaComm functions, you'll need to re-make the com.hackingroomba.roombacomm jar file. Use
